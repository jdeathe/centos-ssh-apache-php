...
DOCKER_IMAGE_TAG_PATTERN := ^(latest|centos-[6-7]|centos-6-httpd24u-php56u|(([1-3]|centos-(6-1|6-httpd24u-php56u-2|7-httpd24u-php72u-3))\.[0-9]+\.[0-9]+))$
DOCKER_IMAGE_RELEASE_TAG_PATTERN := ^(1|2|3|centos-(6-1|6-httpd24u-php56u-2|7-httpd24u-php72u-3))\.[0-9]+\.[0-9]+$
