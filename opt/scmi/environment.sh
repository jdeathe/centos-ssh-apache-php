...
APACHE_CUSTOM_LOG_LOCATION="${APACHE_CUSTOM_LOG_LOCATION:-/var/www/app/var/log/apache_access_log}"
APACHE_ERROR_LOG_LOCATION="${APACHE_ERROR_LOG_LOCATION:-/var/www/app/var/log/apache_error_log}"
...
SERVICE_UID="${SERVICE_UID:-app-1.1.1}"
